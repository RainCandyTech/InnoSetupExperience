...
WDrvPreInstChkSameErrFoundDesc=Find out what to do next.
...
//WDrvPreInstChkSameErrNotFoundDesc=Setup will continue. Other error issues may be resolved after the driver installation.

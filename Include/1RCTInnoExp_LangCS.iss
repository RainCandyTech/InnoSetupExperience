...
chinesesimp.RCTMsgPatchAppVerNotSupport=计算机中安装的%1主程序版本不符合要求。
...
chinesesimp.WDrvFMBootModeHowToASUSExtra=对于某些特定的主板型号，例如某些华硕 H81、B85 主板，您还需要在 UEFI BIOS 设置中对某些选项进行调整，比如“首选显卡”和“初始化 iGPU”选项。

...
#define WPSInstallerType "x64_Unified_Professional_EnHance_VBA_GB"
...
Name: experimental\pdfadvanced; Description: "{cm:RCTISEToEnablePremium, WPS PDF }（必须购买会员或 WPS 365 服务才可使用）"; Types: default;

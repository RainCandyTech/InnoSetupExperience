...
#define MyAppRevisionVer "1"
#define MyAppRevisionDate "260326"
...
//#define RCWinDriverType ""
#define RCWinDriverType "_DCH"
...
//#define NVDrvTargetOS "w7w8"
#define NVDrvTargetOS "w10w11"
...
//AppVersion=v{#MyAppVersion}.{#MyAppTypeVersion}.{#MyAppRevisionVer}{#MyAppPublishType}_{#NVDrvPublishType}{#RCWinDriverType}_{#NVDrvPatchType}_{#MyAppRevisionDate}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppOutputName}_{#MyAppVersion}.{#MyAppTypeVersion}.{#MyAppRevisionVer}{#MyAppPublishType}_{#MyAppArchRCShort}bit_{#NVDrvTargetOS}_{#MyAppRevisionDate}
Compression=lzma2
...
// 20260325_SloganAtBegin
ClickNext=Click Next to continue, or Cancel to exit Setup.%n%nMade with love by RainCandy Technology%n%n{#MyAppExtraInfo}
chinesesimp.ClickNext=单击“下一步”继续，或单击“取消”退出安装程序。%n%n雨糖科技 以爱敬献 | 放手去做吧 剩下的交给奇迹%n%n{#MyAppExtraInfo}
chinesetrad.ClickNext=按 「下一步」 繼續安裝，或按 「取消」 結束安裝程式。%n%n雨糖科技 以愛敬獻 | 放手去做吧 剩下的交給奇蹟%n%n{#MyAppExtraInfo}
...
begin
  AiMofSetupInit;
  Log('[Windose Installer] Info: 「改变世界什么的，我也想做到」');
  Log('[Windose Installer] Info: 放手去做吧，剩下的交给奇迹！');
  Result := True;

...
#define WPSInstallerType "Unified_Professional_Patched"
...
//Source: "{#RCInnoExpProjectDir}\yComponents\WPSSecuritySDKDLL_12.1.0.26895_{#MyAppArchRC}\*.*"; DestDir: "{tmp}\OemFile\office6"; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly; Components: main;
...
//Source: "{#RCInnoExpProjectDir}\yComponents\kappessbuiltinjsapi_12.1.0.26895_ia32\*.*"; DestDir: "{tmp}\OemFile\addons_raincandy\kappessbuiltinjsapi"; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly; Components: main;
...
Source: "E:\Development\WPS Office\yComponents\ElectronicInvoicePrint_12.1.0.26895_{#MyAppArchRC}\*.*"; DestDir: "{tmp}\OemFile\addons_raincandy"; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly; Components: main;
...
Filename: "{sys}\cmd.exe"; StatusMsg: "{cm:RCTISERunInstPrepare}"; Parameters: "/c copy /b {tmp}\oem.ini+{tmp}\wpsshellext_pdf.ini {tmp}\oem.ini"; Flags: runhidden; Components: experimental\wpsshellext and experimental\pdfadvanced;
...
Name: experimental\ebooksupport; Description: "{cm:RCTISEToInst,电子书格式阅读支持（EPUB、MOBI）}（建议随 PDF 高级功能一起开启）";

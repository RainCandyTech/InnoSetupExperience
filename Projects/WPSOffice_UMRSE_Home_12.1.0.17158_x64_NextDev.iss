...
//InfoBeforeFile=
InfoAfterFile="..\Documents\credits_wps_umrse_bgm.rtf"
OutputDir="..\Output"
...
//Source: "{#RCInnoExpProjectDir}\yComponents\kappessbuiltinjsapi_{#MyAppMajorVersion}\*.*"; DestDir: "{tmp}\OemFile\addons_raincandy\kappessbuiltinjsapi"; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly; Components: main;

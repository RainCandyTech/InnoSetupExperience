...
//Source: "{#RCInnoExpProjectDir}\yComponents\GchInkDraw_10.8.2.7119\*.*"; DestDir: "{tmp}\OemFile\gchfeature_raincandy"; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly; Components: main;
...
//Source: "{#RCInnoExpProjectDir}\yComponents\WPSPlusFeature_11.8.2.12265\*.*"; DestDir: "{tmp}\OemFile\addons_raincandy"; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly; Components: main\ksorcnet;

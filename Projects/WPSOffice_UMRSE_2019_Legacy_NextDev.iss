...
#define RCInnoExpVer "v5.6.1.11_240829"
...
; 公文相关方正字体
Source: "{#RCInnoExpProjectDir}\FZFonts\*.*"; DestDir: {tmp}\OemFile; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly; Components: extra\fzfonts;
...
Name: experimental\legacyweblogin; Description: "回退旧版登录页面，解决部分三方账号在系统重启后登录失效"; Flags: dontinheritcheck;
